...
ENV_NAME=jupyterlab-running-sessions
...
publish: clean build ## publish
	npm publish
	echo open https://www.npmjs.com/package/@datalayer/jupyterlab-running-sessions
...
publish-typedoc: typedoc ## deploy typedoc
	aws s3 rm \
		s3://datalayer-typedoc/datalayer/jupyterlab-running-sessions/0.0.1/ \
		--recursive \
		--profile datalayer
	aws s3 cp \
		typedoc \
	...
	aws cloudfront create-invalidation \
		--distribution-id XXX \
		--paths /datalayer/jupyterlab-running-sessions/0.0.1/ \
		--profile datalayer
	echo open ✨  https://typedoc.datalayer.tech/datalayer/jupyterlab-running-sessions/0.0.1
